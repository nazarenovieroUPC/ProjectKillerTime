...
void AProjectKillerTimeCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AProjectKillerTimeCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AProjectKillerTimeCharacter::Look);
...
void AProjectKillerTimeCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AProjectKillerTimeCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AProjectKillerTimeCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AProjectKillerTimeCharacter::DoJumpEnd()
{
